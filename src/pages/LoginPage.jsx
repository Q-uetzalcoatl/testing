...
const LoginPage = ({ onLogin }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Logic: If Admin Mode is ON, send 'admin', otherwise send the email as the name
    // This connects back to your App.jsx handleLogin function
    if (isAdminMode) {
      // In a real app, you'd check the password here. 
      // For now, we trust the mode.
      onLogin('admin');
    } else {
      // Extract name from email or just use email
